...
const CoverView = () => {
    ...
    const applyPreset = useCallback(
        (preset: (typeof COVER_PRESETS)[number]) => {
            setSettings((prev) => ({
                ...prev,
                            ...
                            {settings.pattern.type !== "none" && (
                                <>
                                    ...
                                    <RangeInput
                                        ...
                                        onChange={(v) =>
                                            updatePatternSetting("opacity", v)
                                        }
                                        min={0.05}
                                        max={0.5}
                                        step={0.05}
